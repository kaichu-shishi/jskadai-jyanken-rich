...
const str = [
    '僕は◯◯。',
    '恥ずかしながらこの年齢まで女性経験はほとんどない。',
	'僕は女性経験豊富なオスになりたい。',
	'ちなみに今日は金曜日の夜だ。さて、何をしようか……'
];
...
$('.js-display-choices-button').on('click', function(){
    $('.second-page__choices').css('display', 'block');
    $('.second-page__inner').css('display', 'none');
    $('.second-page__button-area').css('display', 'none');
});

// 選択肢を選んだ後の画面遷移
// $('.js-item3').on('click', function(){
//     $('.third-page__choices').css('display', 'none');
//     $('.third-page__inner').css('display', 'block');
//     $('.third-page__button-area').css('display', 'none');
// });