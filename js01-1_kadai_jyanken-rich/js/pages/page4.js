...
const str = [
    '△△さん：（この人、いきなりじゃんけんを仕掛けてくるなんて…）',
    '（今日のデート相手の人みたいだけど、普通は自己紹介から入るでしょ？）',
    '（てっきり頭のおかしい人に話しかけられたと思って、すごく怖かったんだから…！）',
    '（この人は男として……というか、人としてナシね。）',
    '（適当に言い訳してさっさと帰ろー。こんな男に割く時間がもったいない。世の中にはこんなやつよりいい男なんていっぱいいるんだから！）'
];
